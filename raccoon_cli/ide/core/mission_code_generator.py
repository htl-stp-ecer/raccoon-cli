...
from raccoon_cli.ide.schemas.mission_detail import ParsedMission, ParsedStep, StepArgument, ParsedComment
...
class MissionUpdater:
    ...
    def _update_existing_file(self, mission_file: Path, parsed_mission: ParsedMission) -> bool:
        ...
        from raccoon_cli.ide.core.differential_mission_updater import differential_update
